...
/**
 * @title TelegramCardVault
 * @notice Vault for storing gift cards sent via Telegram username
 *
 * Flow:
 * 1. A user calls createGiftCardForTelegram in GiftCard.sol
 * 2. The NFT is minted directly to this contract and linked to the Telegram username
 ...
 */
contract TelegramCardVault is Ownable, IERC721Receiver {
